      ...
      <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Listen to many of our old students who have learnt exceptionally
            well and transformed into amazing musicians and in-fact some of them
            doing music as their profession in their life.
          </p>
        </div>
      </div>
                ...
                {activeVideo === currentTestimonial ? (
                  ...
                  <div onClick={() => setActiveVideo(currentTestimonial)}>
                    <VideoThumbnail
                      ...
                      className={
                        testimonials[currentTestimonial].isShort
            ...
            <div className="flex justify-center space-x-2 mt-8">
              {testimonials.map((_, index) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      index === currentTestimonial ? "#4A4947" : "#d1d5db",
                  }}
                />
              ))}
            </div>
                ...
                <div className="aspect-video relative">
                  {activeVideo === `grid-${index}` ? (
                    ...
                    <div onClick={() => setActiveVideo(`grid-${index}`)}>
                      <VideoThumbnail testimonial={testimonial} className="h-full" />
                    </div>
                  )}
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <button
                        onClick={() =>
                          window.open(
                            `https://youtube.com/watch?v=${testimonial.embedId}`,
                            "_blank"
                          )
                        }
