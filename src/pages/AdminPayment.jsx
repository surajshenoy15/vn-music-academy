...
const handlePayment = async (student, amount) => {
  try {
    const res = await fetch("https://vn-music-academy-backend-1.onrender.com/api/payment/create-order", {
      method: "POST",
    ...
    const options = {
      ...
      handler: async function (response) {
        const verifyRes = await fetch("https://vn-music-academy-backend-1.onrender.com/api/payment/verify-payment", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
